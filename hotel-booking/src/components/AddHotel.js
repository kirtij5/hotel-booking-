...
const AddHotel = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        Array.from(hotelDetails.hotelImages).forEach((file, i) => {
            formData.append('hotelImages', file);
        });

        try {
            const response = await axios.post('http://localhost:8081/addHotel', formData, {
                headers: {
        ...
        <h2>ADD HOTEL</h2>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input type="file" id="hotelImages" name="hotelImages" onChange={handleFileChange} multiple />
                </div>
