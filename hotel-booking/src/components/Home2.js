...
const Home2 = () => {
  ...
  const handleExploreHotels = () => {
    navigate("/hotel-info"); // Navigate to the HotelInfo page
  };
    ...
    <div className="home-container">
      ...
      <section className="home-section">
        <div className="home-content">
          <h1>InstaStay</h1>
          <p>
            Your ultimate destination for finding the perfect stay for your
            next adventure.
          </p>
          <div className="explore-button" onClick={handleExploreHotels}>
            Explore Hotels
      ...
      <section ref={aboutSectionRef} className="about-section">
        <div className="about-content">
          <h2>About Us</h2>
          <p>
            InstaStay is your go-to platform for discovering and booking the
            ideal accommodations tailored to your needs. Whether it's a
            luxurious hotel suite or a cozy bed and breakfast, we ensure your
            stay is as memorable as your destination.
          </p>
        </div>
        ...
        <div className="about-features">
          ...
          <div className="feature-card">
            ...
            <img
              src={customerReviewsImage}
              alt="Approximate Image"
              className="approx-image"
            />
            <p>
              Explore genuine reviews from fellow travelers to make informed
              decisions.
            </p>
          </div>
        </div>
